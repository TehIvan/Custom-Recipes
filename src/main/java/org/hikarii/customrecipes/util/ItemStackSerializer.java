    ...
    public static Map<String, Object> toMap(ItemStack item) {
        ...
        if (meta != null) {
            ...
            if (meta.hasDisplayName()) {
                ...
                map.put("display-name", net.kyori.adventure.text.serializer.plain.PlainTextComponentSerializer.plainText()
    ...
    public static ItemStack fromMap(Map<String, Object> map) {
        ...
        if (meta != null) {
            ...
            if (map.containsKey("lore")) {
                ...
                java.util.List<String> loreStrings = (java.util.List<String>) map.get("lore");
                java.util.List<net.kyori.adventure.text.Component> loreComponents = loreStrings.stream()
                        .<net.kyori.adventure.text.Component>map(net.kyori.adventure.text.Component::text)
                        .toList();
